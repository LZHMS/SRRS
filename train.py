...
def extend_cfg(cfg, args):
    ...
    cfg.TRAINER.SRRS.BLIP_PATH = './checkpoints/blip/model_base_retrieval_coco.pth'
    cfg.TRAINER.SRRS.AVERAGE_LOSS = True
    cfg.TRAINER.SRRS.AVERAGE_MATCH = True
    cfg.TRAINER.SRRS.WARMUP_EPOCH = 2  # epoch of warm_up function
